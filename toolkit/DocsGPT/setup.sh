...
download_locally() {
    ...
    sudo docker-compose -f docker-compose-local.yaml build && sudo docker-compose -f docker-compose-local.yaml up -d
    #python -m venv venv
    #source venv/bin/activate
    pip install -r application/requirements.txt -i https://pypi.tuna.tsinghua.edu.cn/simple
