...
void MainWindow::SelectBnd()
{
    ...
    cad_dock->ui->actionSelectFace->setChecked(true);
...
void MainWindow::SelectDomain()
{
    ...
    cad_dock->ui->actionSelectFace->setChecked(false);
...
void MainWindow::FEMCompute()
{
    ...
    if (proc->waitForFinished(-1)) {
        vtk_widget->Hide();
        vtk_widget->ImportVTKFile(std::string("/home/jiping/M++/data/vtk/linear_elasticity_deform.vtk"));
